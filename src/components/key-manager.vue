                        ...
                        <v-tab-item>
                            <v-card dark>
                                <v-card-text>
                                    ...
                                    <p class="spacer"></p>
                                    <p v-html="platformService.getHelp($t('keyManager.help.text'))"></p>
                                    <p class="spacer"></p>
                                </v-card-text>
                            </v-card>
                        </v-tab-item>
                            ...
                            <v-card dark>
                                <v-card-text>
                                      <v-layout align-center justify-start row>
                                        ...
                                        <v-flex xs10>
                                            <p class="label">{{ $t("common.help.shortcuts.openEditor") }}</p>
                                        </v-flex>
                                    </v-layout>
                                     <v-layout align-center justify-start row>
                                        <v-flex xs2>
                                     ...
                                     <v-layout align-center justify-start row>
                                        ...
                                        <v-flex xs10>
                                            <p class="label">{{ $t("common.help.shortcuts.remove") }}</p>
                                        </v-flex>
                                    </v-layout>
                                     <v-layout align-center justify-start row>
                                        <v-flex xs2>
                                        ...
                                        <v-flex xs10>
                                            <p class="label">{{ $t("keyManager.help.shortcuts.touch") }}</p>
                                        </v-flex>
                                    </v-layout>
                                    <v-layout align-center justify-start row>
                                        <v-flex xs2>
