                            ...
                            <v-tooltip bottom max-width="200">
                                <template v-slot:activator="{ on }">
                                    ...
                                    >
                                        ...
                                        <span>{{ $t('watcherManager.actions.notificationToggle.label') }}</span>
                                    </v-btn>
                                </template>
                                <span>{{ $t('watcherManager.actions.notificationToggle.tooltip') }}</span>
                            </v-tooltip>
                        </v-toolbar>
                    </template>
                        ...
                        <v-tab-item>
                            <v-card dark>
                                <v-card-text>
                                    ...
                                    <p class="spacer"></p>
                                    <p
                                        v-html="platformService.getHelp($t('watcherManager.help.text'))"
                                    ></p>
                                    <p class="spacer"></p>
                                </v-card-text>
                            </v-card>
